...
class BaseClient:
    ...
    def get_public_ip():
        try:
            ...
            return None
    # Grabbing the country based on the public IP address
    ...
    # If the returned value is "US", then set tld_con = 'us', else 'com'
    if country == 'US':
        tld_con = 'us'
    else:
        tld_con ='com'
    ...
    def __init__(
        ...
        requests_params: Optional[Dict[str, Any]] = None, tld: str = tld_con, base_endpoint: str = BASE_ENDPOINT_DEFAULT,
...
class Client(BaseClient):
    ...
    def __init__(
        self, api_key: Optional[str] = None, api_secret: Optional[str] = None,
        requests_params: Optional[Dict[str, Any]] = None, tld: str = tld_con, #need to figure out how to pass tld_con
